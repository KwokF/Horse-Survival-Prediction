...
## Final Dataset
In this report, for illustrative purposes, we will fit all the models using the `missForest` package as it was also utilized by various research papers with the same dataset. (citation?????) All the results with all the datasets will be reported at the end of the report.
...
nrow(unmerged_complete_case_df) # Number of rows left (for complete case analysis)
```
...
df2 <- data.frame(
  Model = c("multinominal", "single_tree", "random_forest", "xgb_boost", "lasso",
            ...
            "stochastic_gradient_descent", "bayes_naive_model"),
  complete_case = c(0.65, 0.63, 0.67, 0.63, 0.65, 0.65, 0.65, 0.65, 0.63, 0.66, 0.72),
  missForest = c(0.65, 0.64, 0.73, 0.71, 0.71, 0.67, 0.68, 0.71, 0.61, 0.6, 0.75),
  mean_mode_impute = c(0.65, 0.67, 0.72, 0.68, 0.69, 0.69, 0.67, 0.69, 0.63, 0.55, 0.73)
)
...
df3 <- data.frame(
  ...
  complete_case = c(0.76, 0.69, 0.67, 0.65, 0.74, 0.76, 0.72, 0.72, 0.7, 0.63, 0.67),
  missforest = c(0.63, 0.71, 0.67, 0.76, 0.72, 0.72, 0.71, 0.71, 0.68, 0.6, 0.75),
  mean_mode_impute = c(0.69, 0.59, 0.69, 0.75, 0.73, 0.72, 0.68, 0.71, 0.67, 0.58, 0.71)
)
